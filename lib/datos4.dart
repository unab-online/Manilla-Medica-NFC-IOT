...
import 'package:inicio/leerTarjeta.dart';
import 'package:inicio/escribirTarjeta.dart';
...
class ExampleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: Builder(builder: (context) {
          return ListView(
            children: <Widget>[
              ListTile(
                title: const Text("Leer tarjeta"),
                onTap: () {
                  Navigator.pushNamed(context, "/leer");
                },
              ),
              ListTile(
                title: const Text("Escribir tarjeta"),
                onTap: () {
      ...
      routes: {
        "/leer": (context) => LeerTarjeta(),
        "/escribir": (context) => WriteExampleScreen(),
      },
    );
  }
}
